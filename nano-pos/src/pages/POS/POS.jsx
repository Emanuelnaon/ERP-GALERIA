...
export default function POS() {
    ...
    const LOCAL_ACTUAL_ID = 2; // Hardcodeado: Zapatería
    ...
    const searchProducts = async (term) => {
        ...
        const { data, error } = await supabase
            .from("variantes")
            .select(
                `id, codigo_barras, stock_actual, talle, precio:productos(precio_base, nombre)`,
            )
        ...
        <div className="flex h-screen bg-gray-900 text-white overflow-hidden relative">
            ...
            {!cajaAbierta && (
                <div className="absolute inset-0 z-50">
                    <AperturaCajaModal
                        localId={LOCAL_ACTUAL_ID}
                        usuarioId={usuarioActual?.id}
                        onCajaAbierta={(nuevoTurno) =>
                            setCajaAbierta(nuevoTurno)
                        }
                    />
                </div>
            )}
                ...
                <div className="absolute inset-0 z-50">
                    <CierreCajaModal
                        ...
                        onCierreExitoso={() => {
                            ...
                            alert(
                                "✅ ¡Turno cerrado exitosamente! El arqueo fue guardado.",
                            );
                            navigate("/dashboard");
                        }}
                    />
            ...
            >
                ...
                <div className="w-full lg:w-[30%] xl:w-[25%] bg-gray-950 p-4 lg:p-6 flex flex-col shadow-2xl h-[40vh] lg:h-full">
                    <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">
                        <ShoppingCart className="text-green-500" /> Ticket
                        Actual
                    </h2>
