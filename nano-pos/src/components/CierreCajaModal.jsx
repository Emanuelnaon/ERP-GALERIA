...
export default function CierreCajaModal({ turno, onClose, onCierreExitoso }) {
    ...
    const efectivoVentas = Number(turno.efectivo_esperado) || 0;
    const totalEsperado = saldoInicial + efectivoVentas;

    // Calculamos la diferencia en tiempo real mientras escribe
                ...
                <div className="p-6 bg-gray-800/50">
                    <div className="space-y-3 mb-6 text-lg">
                        <div className="flex justify-between text-gray-300">
                            <span>Fondo Inicial (Mañana):</span>
